...
```bash
Deploying aws-lambda-start-stop-ec2 to stage dev (us-east-1)

✔ Service deployed to stack aws-lambda-start-stop-ec2-dev (205s)

functions:
  stopInstance: aws-lambda-start-stop-ec2-dev-stopInstance (1.3 kB)
  startInstance: aws-lambda-start-stop-ec2-dev-startInstance (1.3 kB)
```
